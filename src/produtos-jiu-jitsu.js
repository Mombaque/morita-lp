...
const pathRashguardMasculina = '../public/images/rashguard/masculino/';
const pathRashguardFeminina = '../public/images/rashguard/feminino/';
const pathFaixas = '../public/images/faixas/';

export const produtosJiuJitsu = [
    {
    ...
    },
    {
      ...
      imagens: [
        pathRashguardMasculina + "venum1.jpeg",
        pathRashguardMasculina + "venum2.jpeg",
        pathRashguardMasculina + "venum3.jpeg",
        pathRashguardMasculina + "venum4.jpeg",
        pathRashguardMasculina + "itg1.png",
        pathRashguardMasculina + "itg2.jpg",
        pathRashguardMasculina + "itg3.jpg",
      ]
    },
    {
      ...
      imagens: [
        pathRashguardFeminina + "1.jpeg",
        pathRashguardFeminina + "2.jpeg",
        // pathRashguardFeminina + "feminina3.jpeg",
      ]
    },
  ];